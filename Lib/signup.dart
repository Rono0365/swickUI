            ...
            children: <Widget>[
              ...
              Container(
                    ...
                    setState(() {
                      ...
                      showModalBottomSheet(
                                                ...
                                                builder: (context) {
                                                  return Container(
                                                    child: Center(
                                                      child:Column(mainAxisAlignment: MainAxisAlignment.spaceEvenly,children:[ Text("User Account Created"),
                ...
                onPressed: () {
                  ...
                  if (State2 == 200) {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => MyApp(                             title: "Riara Mobile",
                            token: passtok,
                            userid: userid,
                          ),
                        ));
                ...
                child: Text(
                  ...
                  child: 
                    State == 400 ?Text('retry',style: TextStyle(color: Colors.red, fontSize: 25),):Text('Continue',style: TextStyle(color: Colors.white, fontSize: 25),),
